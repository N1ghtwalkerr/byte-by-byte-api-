        ...
        <div class="row">
            <div class="col-12">
                <div class="card shadow-sm">
                        ...
                        <h6 class="card-title">Introduction to the DOM</h6>
                        <p class="card-text">The **Document Object Model (DOM)** represents the structure of a webpage as a tree of objects. JavaScript allows us to interact with the DOM to change content, styles, and structure dynamically.</p>

                        <h6 class="card-title">Selecting Elements in the DOM</h6>
                        <p class="card-text">To manipulate elements, we first need to select them. JavaScript provides several methods to do this.</p>
                        
                        <h6 class="card-title">1. getElementById()</h6>
                        <p class="card-text">Selects an element by its `id`.</p>
...
console.log(title.innerText);            
                        ...
                        <h6 class="card-title">2. querySelector() and querySelectorAll()</h6>

                        <p class="card-text">`querySelector()` selects the first matching element, while `querySelectorAll()` selects all matching elements.</p>
...
<iframe width="1090" height="400" src="https://www.youtube.com/embed/H63dVFDuJDM" frameborder="0" allowfullscreen></iframe>
    </div> 

                        <!-- Video: Modifying Elements in the DOM -->
                        <div class="text-align-left mt-3 mb-3">
                        <h6 class="card-title">Modifying Elements in the DOM</h6>

                        <p class="card-text">Once an element is selected, we can change its properties such as text, HTML content, and styles.</p>
    
                            <iframe width="1110" height="400" src="https://www.youtube.com/embed/yc-AeIdRVEI" frameborder="0" allowfullscreen></iframe>
                        </div>
                        
                        <!-- Start Quiz and Back Button -->
<div class="d-flex justify-content-center mt-4">
    <a href="javascriptview.php" class="btn btn-secondary btn-lg">Back</a>
    <a href="javascriptviewlesson4.1.php" class="btn btn-primary btn-lg">Next</a>
</div>
                    </div>
                </div>
            </div>
