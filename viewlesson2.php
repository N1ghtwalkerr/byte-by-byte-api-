...
<div class="sidebar" id="sidebar">
    ...
    <!-- Content -->
     <!-- Video: Introduction to Variables & Data Types -->
        ...
        <div class="row">
            <div class="col-12">
                <div class="card shadow-sm">
                    <div class="card-body">
                        <h2 class="card-title">Python Data Types</h2>
                        
                        <h6 class="card-title">Built-in Data Types</h6>
                        <p class="card-text">In programming, data type is an important concept. Variables can store data of different types, and different types can do different thins.</p>
                        
                        <p class="card-text">Python has the following data types built-in by default, in these categories:</p>
...
None Type:        NoneType
                        ...
                        <h6 class="card-title">Getting the Data Type</h6>

                        <p class="card-text">You can get the data type of any object by using the type() function:</p>
                        
                        <h7 class="card-title">Example</h7>
                        <p class="card-text">Print the data type of the variable x:</p>
                        <p class="card-text">x = 5</p>
                        <p class="card-text">print(type(x))</p>

                        <h6 class="card-title">Setting the Data Type</h6>
                        <p class="card-text">In Python, the data type is set when you assign a value to a variable:</p>
...
x = ['apple", "banana", "cherry"]                           list
                        ...
                        <h6 class="card-title">Setting the Specific Data Type</h6>
                        <p class="card-text">If you want to specify the data type, you can use the following constructor functions:</p>
...
<iframe width="1090" height="400" src="https://www.youtube.com/embed/KrToaEvDzdk" frameborder="0" allowfullscreen></iframe>
                            </div>

                        <!-- Start Quiz and Back Button -->
<div class="d-flex justify-content-center mt-4">
    <a href="view.php" class="btn btn-secondary btn-lg">Back</a>
    <a href="viewlesson2.1.php" class="btn btn-primary btn-lg">Next</a>
