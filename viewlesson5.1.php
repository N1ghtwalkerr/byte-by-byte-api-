...
<div class="sidebar" id="sidebar">
    <ul>
        ...
        <li><a href="#" style="font-size: 22px; font-weight: bold;">Introduction to Python</a></li>
        ...
        <li><a href="#"></a></li>
        <li><a href="#"></a></li>
        <li><a href="#" style="font-size: 22px; font-weight: bold;">JavaScript Fundamentals</a></li>
        ...
        <li><a href="#"></a></li>
        <li><a href="#"></a></li>
        <li><a href="#" style="font-size: 22px; font-weight: bold;">Java Programming</a></li>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card shadow-sm">
                    ...
                    <!-- Video: The if-elif-else Statement -->
                    <div class="text-align-left mt-3 mb-3">
                    <h6 class="card-title">3. The if-elif-else Statement</h6>
                    <p class="card-text">Use this when checking multiple conditions.</p>
...
<iframe width="1090" height="400" src="https://www.youtube.com/embed/42MBMSOZgD4" frameborder="0" allowfullscreen></iframe>
    </div> 
                
    <!-- Video: Logical Operators in Conditional Statements -->
    <div class="text-align-left mt-3 mb-3">
                        <h6 class="card-title">4. Logical Operators in Conditional Statements</h6>
                        <p class="card-text">Python allows logical operators to combine conditions:</p>
...
Both conditions are met
                        ...
                        <iframe width="1090" height="400" src="https://www.youtube.com/embed/K47w0cpRLt4" frameborder="0" allowfullscreen></iframe>
                            </div> 

                        <!-- Start Quiz and Back Button -->
<div class="d-flex justify-content-center mt-4">
<a href="viewlesson5.php" class="btn btn-secondary btn-lg">Back</a>
    <a href="quiz5.php" class="btn btn-primary btn-lg">Start Quiz</a>
                </div>
            </div>
        </div>
    </div>
