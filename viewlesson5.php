...
<div class="sidebar" id="sidebar">
    ...
    <div class="container mt-5 pt-4 content">
        <h2 class="text-center mb-4">Python Functions</h2>
        <h3 class="text-center mb-4">Lesson 5: Conditional Statements - Learn how to make decisions in code using if-else conditions.</h3>
        <div class="row">
            <div class="col-12">
                <div class="card shadow-sm">
                    <div class="card-body">
                    <h6 class="card-title">Introduction</h6>
                        <p class="card-text">Conditional statements in Python allow a program to make decisions based on conditions. These conditions evaluate to either True or False, and the program executes different blocks of code accordingly.
                        </p>
                        
                        <!-- Video: Conditional Statements -->
                        <div class="text-align-left mt-3 mb-3">
                        <h6 class="card-title">Types of Conditional Statements</h6>
                        <p class="card-text">• if Statement - Runs a block of code only if the condition is true.</p>
                        <p class="card-text">• if-else Statement - Runs one block if the condition is true, and another block if it is false.</p>
                        <p class="card-text">• if-elif-else Statement - Checks multiple conditions, executing different blocks of code depending on which condition is met.</p>

                        <iframe width="1090" height="400" src="https://www.youtube.com/embed/-KU5td4YlUs" frameborder="0" allowfullscreen></iframe>
                            </div> 
                        
                            <!-- Video: The if Statement -->
                        <div class="text-align-left mt-3 mb-3">
                        <h5 class="card-title">1. The if Statement</p>
                        <p class="card-text">The if statement evaluates a condition. If it's true, the indented code runs.</p>
...
x is greater than 5
                        ...
                        <iframe width="1090" height="400" src="https://www.youtube.com/embed/wKQRmXR3jhc" frameborder="0" allowfullscreen></iframe>
                            </div> 

                    
                        <h6 class="card-title">2. The if-else Statement</h6>
                        <p class="card-text">If the condition is false, the else block executes.</p>
...
x is not greater than 5
                        ...
                        <iframe width="1090" height="400" src="https://www.youtube.com/embed/-BOBedcjySI" frameborder="0" allowfullscreen></iframe>
                            </div>
    ...
    <a href="viewlesson5.1.php" class="btn btn-primary btn-lg">Next</a>
                </div>
            </div>
        </div>
    </div>
