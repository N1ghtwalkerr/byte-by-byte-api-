...
<div class="sidebar" id="sidebar">
    ...
    <div class="container mt-5 pt-4 content">
        <h3 class="text-center mb-4">Lesson 4: Functions/Methods in Java</h3>
        <div class="row">
            <div class="col-12">
                <div class="card shadow-sm">

                        <!-- Video: Defining and Calling Methods -->
                        <div class="text-align-left mt-3 mb-3">
                        <h6 class="card-title">Defining and Calling Methods</h6>

                        <p class="card-text">A method must be declared before it can be used. It consists of:</p>
                        <p class="card-text">• Return Type: The type of data the method returns (or void if it doesn’t return anything).</p>
                        <p class="card-text">• Method Name: Identifies the method.</p>
                        <p class="card-text">• Parameters (Optional): Input values passed to the method.</p>
                        <p class="card-text">• Method Body: Contains the statements to execute.</p>

                        <h6 class="card-title">Example: A Simple Method</h6>
                        <pre class="card-text">
...
<iframe width="1090" height="400" src="https://www.youtube.com/embed/cQ_aQDohrts" frameborder="0" allowfullscreen></iframe>
                        </div>

                        <!-- Video: Methods with Return Values -->
                        <div class="text-align-left mt-3 mb-3">
                        <h6 class="card-title">Methods with Return Values</h6>
                        <p class="card-text">Instead of just printing results, methods can return values to the caller.</p>
                       
                        <p class="card-text">Example: Returning a Value</p>
                        <pre class="card-text">
...
<iframe width="1090" height="400" src="https://www.youtube.com/embed/5bnrKjv5pwI" frameborder="0" allowfullscreen></iframe>
    </div>                           

                        <!-- Video: Passing Parameters and Arguments -->
                        <div class="text-align-left mt-3 mb-3">
                        <h6 class="card-title">Passing Parameters and Arguments</h6>

                        <p class="card-text">Example: Passing Parameters</p>
                        <pre class="card-text">  
public class ParameterExample {
    ...
    <iframe width="1090" height="400" src="https://www.youtube.com/embed/Jszmzj_8L1Q" frameborder="0" allowfullscreen></iframe>
        </div>    

                        <!-- Video: Recursive Methods -->
                        <div class="text-align-left mt-3 mb-3">
                        <h6 class="card-title">Recursive Methods</h6>

                        <h6 class="card-title">Example: Factorial Calculation</h6>
                        <pre class="card-text">
...
public class RecursionExample {
    ...
    public static void main(String[] args) {
        System.out.println("Factorial of 5: " + factorial(5));
                            ...
                            <iframe width="1110" height="400" src="https://www.youtube.com/embed/ivl5-snqul8" frameborder="0" allowfullscreen></iframe>
                        </div>
                        
                        <!-- Start Quiz and Back Button -->
<div class="d-flex justify-content-center mt-4">
    <a href="javaviewlesson4.php" class="btn btn-secondary btn-lg">Back</a>
    <a href="javaquiz4.php" class="btn btn-primary btn-lg">Start Quiz</a>
</div>
                    </div>
                </div>
            </div>
