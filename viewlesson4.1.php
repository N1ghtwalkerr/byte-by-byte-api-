        ...
        <div class="row">
            <div class="col-12">
                <div class="card shadow-sm">
                    <div class="card-body">
                        <h6 class="card-title">Loop Control Statements</h6>
                        <p class="card-text">Loop control statements modify the normal flow of loops.</p>
                        
                         <!-- Video: Break Statement, Continue Statement -->
    <div class="text-align-left mt-3 mb-3">
                        <h6 class="card-title">1. Break Statement</h6>
                        <p class="card-text">Used to exit a loop prematurely when a certain condition is met.</p>
...
print(i)  # Output: 1 2
                        ...
                        <h5 class="card-title">Example with `break`:</h5>
    ...
    public static void main(String[] args) {
        for (int i = 1; i <= 5; i++) {
            ...
            ystem.out.println(i); // Output: 1 2
                        ...
                        <h6 class="card-title">2. Continue Statement</h6>
                        <p class="card-text">Skips the current iteration and moves to the next one.</p>
...
<iframe width="1065" height="400" src="https://www.youtube.com/embed/Rjjgy2QWS98" frameborder="0" allowfullscreen></iframe>
    </div>

    <!-- Video: Nested Loops -->
    <div class="text-align-left mt-3 mb-3">
                        <h6 class="card-title">3. Nested Loops</h6>
                        <p class="card-text">A nested loop is a loop inside another loop.</p>
...
<iframe width="1065" height="400" src="https://www.youtube.com/embed/APWy6Pc83gE" frameborder="0" allowfullscreen></iframe>
    </div>

                        <!-- Start Quiz and Back Button -->
<div class="d-flex justify-content-center mt-4">
    <a href="viewlesson4.php" class="btn btn-secondary btn-lg">Back</a>
    <a href="quiz4.php" class="btn btn-primary btn-lg">Start Quiz</a>
</div>
                </div>
            </div>
        </div>
