        ...
        <div class="row">
            <div class="col-12">
                <div class="card shadow-sm">
                        <h5 class="card-title">What is Python?</h5>
                        <p class="card-text">Python is a popular programming language. It was created by Guido van Rossum, and released in 1991.</p>
                        <p class="card-text">Python is a high-level, interpreted programming language created by Guido van Rossum in 1991. It is known for its simple syntax and readability, making it a great choice for beginners.</p>

                        <p class="card-text">It is used for:</p>

                        <p class="card-text">• web development (server-side),</p>
                        <p class="card-text">• software development,</p>
                        <p class="card-text">• mathematics,</p>
                        <p class="card-text">• system scripting.</p>

                        <h6 class="card-title">What can Python do?</h6>

                        <p class="card-text">• Python can be used on a server to create web applications.</p>
                        <p class="card-text">• Python can be use alongside software to create workflows.</p>
                        <p class="card-text">• Python can connect to database systems. It can also read and modify files.</p>
                        <p class="card-text">• Python can be used to handle big data and perform complex mathematics.</p>
                        <p class="card-text">• Python can be used for rapid prototyping, or for production-ready software development.</p>

                        <h6 class="card-title">Why Python?</h6>
                        <p class="card-text">• Python works on different platforms (Windows, Mac, Linux, Raspberry Pi, etc).</p>
                        <p class="card-text">• Python has a simple syntax similar to the English language.</p>
                        <p class="card-text">• Python has syntax that allows developers to write programs with fewer lines than some other programming languages.</p>
                        <p class="card-text">• Python runs on an interpreter system, meaning that code can be executed as sonn as it is written. This means that prototyping can be very quick.</p>
                        <p class="card-text">• Python can be treated in a procedural way, an object-oriented way or a functional way.</p>
                            ...
                            <iframe width="1090" height="400" src="https://www.youtube.com/embed/fWjsdhR3z3c" frameborder="0" allowfullscreen></iframe>
                        </div>
                        
                        <!-- Start Quiz and Back Button -->
<div class="d-flex justify-content-center mt-4">
    <a href="view.php" class="btn btn-secondary btn-lg">Back</a>
    <a href="viewlesson1.1.php" class="btn btn-primary btn-lg">Next</a>
</div>
                    </div>
                </div>
            </div>
