            ...
            <div class="col-12">
                <div class="card shadow-sm">
                    ...
                    <div class="text-align-left mt-3 mb-3">
                        <h6 class="card-title">1. if-else Statements</h6>
                        <p class="card-text">An `if-else` statement executes a block of code if a specified condition is true; otherwise, it executes another block.</p>
...
<iframe width="1090" height="400" src="https://www.youtube.com/embed/IsG4Xd6LlsM" frameborder="0" allowfullscreen></iframe>
    </div>

                        <!-- Video: Switch Statements -->
                        <div class="text-align-left mt-3 mb-3">
                        <h6 class="card-title">2. Switch Statements</h6>
                        <p class="card-text">A `switch` statement is used when you have multiple conditions to check.</p>
                        <h6 class="card-title">Example:</h6>
                        <pre class="card-text">    
let day = "Monday";
switch (day) {
...
<iframe width="1090" height="400" src="https://www.youtube.com/embed/fM5qnyasUYI" frameborder="0" allowfullscreen></iframe>
    </div>

                        <!-- Video: Loops in JavaScript -->
                        <div class="text-align-left mt-3 mb-3">
                        <h6 class="card-title">3. Loops in JavaScript</h6>

                        <p class="card-text">Loops allow us to execute a block of code multiple times. The most common loops are `for`, `while`, and `do-while`.</p>
...
<iframe width="1090" height="400" src="https://www.youtube.com/embed/s9wW2PpJsmQ" frameborder="0" allowfullscreen></iframe>
    </div>

                        <!-- Video: While Loop -->
                        <div class="text-align-left mt-3 mb-3">
                        <h6 class="card-title">While Loop in JavaScript</h6>
                        <p class="card-text">A `while` loop runs as long as a condition remains true.</p>
                        <h6 class="card-title">Example:</h6>
                        <pre class="card-text">
let count = 1;
while (count <= 3) {
...
<iframe width="1090" height="400" src="https://www.youtube.com/embed/TDUz9QcGPoE" frameborder="0" allowfullscreen></iframe>
    </div>
...
3. Write an `if-else` statement to check whether a number is even or odd.                           
</pre>
...
<div class="d-flex justify-content-center mt-4">
    ...
    <a href="javascriptquiz3.php" class="btn btn-primary btn-lg">Start Quiz</a>
</div>
                    </div>
                </div>
            </div>
