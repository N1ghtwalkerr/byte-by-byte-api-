...
<div class="sidebar" id="sidebar">
    ...
    <div class="container mt-5 pt-4 content">
        <h2 class="text-center mb-4">Introduction to Python Funtions</h2>
        <h3 class="text-center mb-4">Lesson 3: Functions - Learn how to create and use functions to organize code.</h3>
        <div class="row">
            <div class="col-12">
                <div class="card shadow-sm">
                    <div class="card-body">
                        
                        <h6 class="card-title">Python Functions</h6>
                        <p class="card-text">Functions help organize and reuse code. They allow you to write a block of code once and call it multiple times.</p>
                        
                        <h5 class="card-title">Defining a Function</p>
                        <p class="card-text">A function is created using the def keyword</p>
...
Output: Hello, welcome to Python!
    ...
    <!-- Video: Function with Parameters -->
    <div class="text-align-left mt-3 mb-3">
                        <h6 class="card-title">Function with Parameters</h6>
                        <p class="card-text">Functions can take parameters (inputs) to make them more flexible</p>
...
<iframe width="1090" height="400" src="https://www.youtube.com/embed/CGRKqnoQGgM" frameborder="0" allowfullscreen></iframe>
    </div>

    <!-- Video: Function with Return Value -->
    <div class="text-align-left mt-3 mb-3">
                        <h6 class="card-title">Function with Return Value</h6>
                        <p class="card-text">A function can return a value using the return keyword.</p>
...
<iframe width="1090" height="400" src="https://www.youtube.com/embed/qKf_gSr8CSM" frameborder="0" allowfullscreen></iframe>
    </div>

<!-- Video: Default Parameter Values -->
    <div class="text-align-left mt-3 mb-3">
                        <h6 class="card-title">Default Parameter Values</h6>
                        <p class="card-text">You can set default values for parameters.</p>
...
<iframe width="1090" height="400" src="https://www.youtube.com/embed/KeRxe9rll2Q" frameborder="0" allowfullscreen></iframe>
    </div>

    <!-- Video: Lambda Functions -->
    <div class="text-align-left mt-3 mb-3">
                        <h6 class="card-title">Lambda Functions</h6>
                        <p class="card-text">A lambda function is a one-line anonymous function.</p>
...
<iframe width="1090" height="400" src="https://www.youtube.com/embed/HQNiSfb795A" frameborder="0" allowfullscreen></iframe>
    </div>

                        <!-- Start Quiz and Back Button -->
<div class="d-flex justify-content-center mt-4">
    <a href="view.php" class="btn btn-secondary btn-lg">Back</a>
    <a href="viewlesson3.1.php" class="btn btn-primary btn-lg">Next</a>
