...
<div class="header">
    <div class="d-flex flex-column align-items-center">
        ...
        <h4 class="mt-3 text-center">Welcome to Byte-By-Byte Coding Tutorial Mobile App</h4>
    </div>
</div>
            ...
            <div class="col-12">
                <div class="card shadow-sm">
                    <div class="card-body">
                        ...
                        <p class="card-text">Learn the basics of Python programming, including syntax, variables, and functions.</p>
                        <a href="view.php" class="btn btn-primary btn-sm">View Lessons</a>
                    </div>
                </div>
            </div>
            <!-- Subject 2 -->
            <div class="col-12">
                <div class="card shadow-sm">
                    <div class="card-body">
                        ...
                        <p class="card-text">Master the core concepts of JavaScript, including DOM manipulation and events.</p>
                        <a href="javascriptview.php" class="btn btn-primary btn-sm">View Lessons</a>
                    </div>
                </div>
            </div>
            <!-- Subject 4 -->
            <div class="col-12">
                <div class="card shadow-sm">
                    <div class="card-body">
                        ...
                        <a href="javaview.php" class="btn btn-primary btn-sm">View Lessons</a>
                    </div>
                </div>
            </div>
