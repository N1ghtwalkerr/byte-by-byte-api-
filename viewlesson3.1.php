...
<div class="sidebar" id="sidebar">
    ...
    <!-- Content -->
     <!-- Video: Introduction to Python Funtions -->
        ...
        <div class="row">
            <div class="col-12">
                <div class="card shadow-sm">
                    <div class="card-body">
                        <h6 class="card-title">Types of Functions</h6>
                        <p class="card-text">Functions can be classified into different types based on their behavior and usage.</p>

                        <h5 class="card-title">1. Built-in Functions</h5>
                        <p class="card-text">These are functions provided by the programming language, such as print() in Python or System.out.println() in Java.</p>

                        <h5 class="card-title">2. User-defined Functions</h5>
                        <p class="card-text">These are functions created by the programmer to perform specific tasks.</p>

                        <h5 class="card-title">3. Recursive Functions</h5>
                        <p class="card-text">A recursive function is a function that calls itself within its definition. It is useful for solving problems like factorial calculation and Fibonacci series.</p>

                        <h6 class="card-title">Python Example:</h6>
...
print(factorial(5))  # Output: 120
                        ...
                        <h6 class="card-title">Java Example</h6>
...
<iframe width="1090" height="400" src="https://www.youtube.com/embed/NE97ylAnrz4" frameborder="0" allowfullscreen></iframe>
    </div>
                        <h6 class="card-title">Summary</h6>

                        <p class="card-text">• Functions allow you to organize code into reusable blocks.</p>
                        <p class="card-text">• They can accept parameters to make them more flexible.</p>
                        <p class="card-text">• They can return values to be used in other parts of the program.</p>
                        <p class="card-text">• Functions can be categorized as built-in, user-defined, or recursive.</p>
                        
                        <!-- Start Quiz and Back Button -->
<div class="d-flex justify-content-center mt-4">
    <a href="viewlesson3.php" class="btn btn-secondary btn-lg">Back</a>
    <a href="quiz3.php" class="btn btn-primary btn-lg">Start Quiz</a>
</div>
                    </div>
                </div>
            </div>
