        ...
        <div class="row">
            <div class="col-12">
                <div class="card shadow-sm">
                        <h6 class="card-title">JavaScript Variables</h6>
                        <p class="card-text">In JavaScript, variables store data values. You can declare variables using `var`, `let`, or `const`. The `let` and `const` keywords are preferred in modern JavaScript because they offer better scoping and immutability.</p>

                        <h6 class="card-title">Example:</h6>
                        <pre class="card-text">
let name = "John";  // Declaring a string variable
const age = 25;  // Declaring a constant number variable
console.log(name, age);
    </pre>

                        <!-- Video: Difference Between var, let, and const -->
                        <div class="text-align-left mt-3 mb-3">
                        <h6 class="card-title">Difference Between var, let, and const</h6>

                        <p class="card-text">• `var`: Function-scoped, can be re-declared and updated.</p>
                        <p class="card-text">• `let`: Block-scoped, can be updated but not re-declared.</p>
                        <p class="card-text">• `const`: Block-scoped, cannot be updated or re-declared.</p>

                        <iframe width="1090" height="400" src="https://www.youtube.com/embed/9WIJQDvt4Us" frameborder="0" allowfullscreen></iframe>
                        </div>

                        <!-- Video: JavaScript Data Types -->
                        <div class="text-align-left mt-3 mb-3"></div>
                        <h6 class="card-title">JavaScript Data Types</h6>

                        <p class="card-text">JavaScript supports different types of data that can be stored in variables. The most common data types include:</p>
                        <p class="card-text">• **String:** A sequence of characters, written inside quotes (e.g., "hello").</p>
                        <p class="card-text">• **Number:** Can be integers or floating-point values (e.g., 25, 3.14).</p>
                        <p class="card-text">• **Boolean:** Represents `true` or `false`.</p>
                        <p class="card-text">• **Array:** A collection of values, written inside square brackets (e.g., `[1, 2, 3]`).</p>
                        <p class="card-text">• **Object:** A collection of key-value pairs, written inside curly braces (e.g., `{name: 'John', age: 25}`).</p>
...
console.log(person.name, person.age);
                        ...
                        <iframe width="1090" height="400" src="https://www.youtube.com/embed/JZeH6LYvH6g" frameborder="0" allowfullscreen></iframe>
                        </div>

                        <!-- Video: JavaScript Operators -->
                        <div class="text-align-left mt-3 mb-3">
                        <h6 class="card-title">JavaScript Operators</h6>

                        <p class="card-text">Operators are used to perform operations on variables and values. JavaScript has several types of operators:</p>
                        
                        <p class="card-text">1. Arithmetic Operators</p>
                        <pre class="card-text">
...
console.log(sum);  // Output: 15
                        ...
                        <iframe width="1090" height="400" src="https://www.youtube.com/embed/ovWYhDVQiR8" frameborder="0" allowfullscreen></iframe>
                        </div>

                        <!-- Start Quiz and Back Button -->
<div class="d-flex justify-content-center mt-4">
    <a href="javascriptview.php" class="btn btn-secondary btn-lg">Back</a>
    <a href="javascriptviewlesson2.1.php" class="btn btn-primary btn-lg">Next</a>
</div>
                    </div>
                </div>
            </div>
