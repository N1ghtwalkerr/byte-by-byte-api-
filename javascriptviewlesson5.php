        ...
        <div class="row">
            <div class="col-12">
                <div class="card shadow-sm">
                        ...
                        <p class="card-text">• **click** – When a user clicks an element</p>
                        <p class="card-text">• **mouseover** – When a user hovers over an element</p>
                        <p class="card-text">• **keydown** – When a user presses a key</p>
                        <p class="card-text">• **load** – When the page finishes loading</p>
