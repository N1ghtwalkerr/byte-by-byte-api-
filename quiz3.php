...
$_SESSION['answers'] = ['c', 'a', 'b', 'c', 'a']; // Correct answers
...
<body>
    <div class="container mt-5">
        <h2 class="text-center">Quiz - Functions</h2>
        <h3 class="text-center">Lesson 3: Functions - Learn how to create and use functions to organize code.</h3>
    ...
    <div class="progress mb-4">
        ...
        <form action="result3.php" method="post" id="quizForm">
            <?php $index = 0; ?>
