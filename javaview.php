...
<div class="sidebar" id="sidebar">
    ...
    <div class="container mt-5 pt-4 content">
        <h2 class="text-center mb-4">Introduction to Java Programming</h2>
        <div class="row">
            <div class="col-12">
                <div class="card shadow-sm">
                    <div class="card-body">
                        ...
                        <li><strong>Lesson 1:</strong> 
                            <a href="javaviewlesson1.php" class="text-primary">Java Programming</a>
                        </li>
                        <li><strong>Lesson 2:</strong> 
                            <a href="javaviewlesson2.php" class="text-primary">Variables and Data Type</a>
                        </li>
                        <li><strong>Lesson 3:</strong> 
                            <a href="javaviewlesson3.php" class="text-primary">Control Structures</a>
                        </li>
                        <li><strong>Lesson 4:</strong> 
                            <a href="javaviewlesson4.php" class="text-primary">Functions/Methods in Java</a>
                        </li>
                        <li><strong>Lesson 5:</strong> 
                            <a href="javaviewlesson5.php" class="text-primary">Introduction to Object-Oriented Programming (OOP)</a>
                        </li>
                    </ul>
                </div>
            </div>
