...
session_start();
$questions = [
    "What will be the output of this code?\n x = 8\nif x 902 == 0:\n    print(\"even\")\nelse:\n    print(\"odd\")" => ["a. even", "b. odd", "c. Error", "d. None"],
    "Which of the following is NOT a valid comparison operator in Python?" => ["a. ==", "b. !=", "c. <>", "d. <="],
    "What is the purpose of the not operator in Python?" => ["a. It inverts the truth value of a condition", "b. It checks for inequality", "c. It is used for looping", "d. It always returns true"],
    "What will be the output of this code?\n x = 10\ny = 5\nif x > 5 and y < 10:\n    print(\"condition met\")" => ["a. condition met", "b. no output", "c. error", "d. none of the above"],
    "Which of the following statements is true about Python’s if-elif-else statements?" => ["a. You can have only one elif in an if-elif-else structure", "b. The else block is mandatory", "c. The if condition must always be a boolean expression", "d. Python uses switch-case instead of if-elif-else"]
];

$_SESSION['answers'] = ['c', 'c', 'a', 'a', 'c']; // Correct answers
...
<head>
    ...
    <title>Quiz - Conditional Statements</title>
...
<body>
    <div class="container mt-5">
        <h2 class="text-center">Quiz - Conditional Statements</h2>
        ...
        <form action="result5.php" method="post" id="quizForm">
            <?php $index = 0; ?>
