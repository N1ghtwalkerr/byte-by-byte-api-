...
<div class="sidebar" id="sidebar">
    ...
    <div class="container mt-5 pt-4 content">
        <h3 class="text-center mb-4">Lesson 1: Introduction to Java Programming</h3>
        <div class="row">
            <div class="col-12">
                <div class="card shadow-sm">
                    <div class="card-body">
                        <!-- Video: First Java Program: "HelloWorld.java -->
                        <div class="text-align-left mt-3 mb-3">
                        <h2 class="card-title">3. First Java Program: "HelloWorld.java"</h2>
                        <p class="card-text">A Java program consists of classes and a main method, which serves as the program's entry point.</p>

                        <p class="card-text">Here’s a simple program to print "Hello, Java!" on the screen:</p>
                        <pre class="card-text">
                        ...
                        <iframe width="1090" height="400" src="https://www.youtube.com/embed/mKhczNyjqQQ" frameborder="0" allowfullscreen></iframe>
                        </div>

                        <!-- Video: Compiling and Running a Java Program -->
                        <div class="text-align-left mt-3 mb-3">
                        <h2 class="card-title">4. Compiling and Running a Java Program.</h2>
                        <p class="card-text">To run the program:</p>

                        <h2 class="card-title">Step 1: Compile the Code</h2>
                        <p class="card-text">Open the terminal or command prompt, navigate to the folder where HelloWorld.java is saved, and type:</p>
                        
                        <p class="card-text">javac HelloWorld.java</p>
                        <p class="card-text">This creates a HelloWorld.class file (bytecode).</p>

                        <h2 class="card-title">Step 2: Run the Program</h2>
                        <p class="card-text">Execute the compiled program with:</p>
                        
                        <p class="card-text">java HelloWorld</p>
                        <p class="card-text">Output:</p>
                        <p class="card-text">Hello, Java!</p>
                        <iframe width="1090" height="400" src="https://www.youtube.com/embed/gHXzyAkbUhk" frameborder="0" allowfullscreen></iframe>
                        </div>
      
                      <!-- Start Quiz and Back Button -->
<div class="d-flex justify-content-center mt-4">
<a href="javaviewlesson1.php" class="btn btn-secondary btn-lg">Back</a>
    <a href="javaquiz1.php" class="btn btn-primary btn-lg">Start Quiz</a>
                </div>
            </div>
        </div>
    </div>
