...
<div class="sidebar" id="sidebar">
    ...
    <div class="container mt-5 pt-4 content">
        <h2 class="text-center mb-4">Introduction to JavaScript Fundamentals</h2>
        <div class="row">
            <div class="col-12">
                <div class="card shadow-sm">
                    <div class="card-body">
                        <h5 class="card-title">Introduction to JavaScriptg</h5>
                        <p class="card-text">Dive into object-oriented programming with Java and learn to build robust applications.</p>
                        <li><strong>Lesson 1:</strong> 
                            <a href="javascriptviewlesson1.php" class="text-primary">Introduction to JavaScript</a>
                        </li>
                        <li><strong>Lesson 2:</strong> 
                            <a href="javascriptviewlesson2.php" class="text-primary">JavaScript Variables, Data Types, and Operators</a>
                        </li>
                        <li><strong>Lesson 3:</strong> 
                            <a href="javascriptviewlesson3.php" class="text-primary">Functions and Control Flow</a>
                        </li>
                        <li><strong>Lesson 4:</strong> 
                            <a href="javascriptviewlesson4.php" class="text-primary">DOM Manipulation</a>
                        </li>
                        <li><strong>Lesson 5:</strong> 
                            <a href="javascriptviewlesson5.php" class="text-primary">JavaScript Events</a>
                        </li>
                    </ul>
                </div>
            </div>
