        ...
        <div class="row">
            <div class="col-12">
                <div class="card shadow-sm">
                        ...
                        <p class="card-text">JavaScript is a high-level, interpreted programming language that allows developers to add interactivity to web pages. Unlike HTML (which defines structure) and CSS (which styles elements), JavaScript makes pages dynamic by enabling real-time updates, animations, event handling, and more.</p>
                        
                        <h6 class="card-title">What is JavaScript?</h6>
                        <p class="card-text">JavaScript is a high-level, interpreted programming language that allows developers to add interactivity to web pages. Unlike HTML (which defines structure) and CSS (which styles elements), JavaScript makes pages dynamic by enabling real-time updates, animations, event handling, and more.</p>

                        <h6 class="card-title">Key Features of JavaScript:</h6>
                        p class="card-text">• Client-Side Execution – JavaScript runs directly in the browser.</p>
                        <p class="card-text">• Event-Driven – JavaScript responds to user actions.</p>
                        <p class="card-text">• Dynamic Typing – Variables do not require explicit type definitions.</p>
                        <p class="card-text">• Object-Oriented – JavaScript is based on objects.</p>
                        <p class="card-text">• Cross-Browser Support – Works on all modern web browsers.</p>
                        <h6 class="card-title">How JavaScript Works in a Webpage</h6>
                        <p class="card-text">When a webpage loads, the browser processes HTML first, then CSS, and finally JavaScript. JavaScript interacts with the DOM (Document Object Model), allowing it to manipulate HTML elements dynamically.</p>

                        <h6 class="card-title">Example of JavaScript Modifying HTML Dynamically:</h6>
    ...
    < script>
        function changeText() {
            document.getElementById("title").innerText = "Hello, JavaScript!";
                            ...
                            <iframe width="1090" height="400" src="https://www.youtube.com/embed/upDLs1sn7g4" frameborder="0" allowfullscreen></iframe>
                        </div>
                        
                        <!-- Start Quiz and Back Button -->
<div class="d-flex justify-content-center mt-4">
    <a href="javascriptview.php" class="btn btn-secondary btn-lg">Back</a>
    <a href="javascriptviewlesson1.1.php" class="btn btn-primary btn-lg">Next</a>
</div>
                    </div>
                </div>
            </div>
