...
<div class="container mt-5 pt-4 content">
        <h2 class="text-center mb-4">Loops in Python</h2>
        <h3 class="text-center mb-4">Lesson 4: Loops - Master for and while loops to handle repetitive tasks.</h3>
        <div class="row">
            <div class="col-12">
                <div class="card shadow-sm">
                    <div class="card-body">
                        <h6 class="card-title">Introduction Of Loops</h6>
                        <p class="card-text">Loops in Python are used to execute a block of code multiple times. Python provides two primary loop types: for loops and while loops. Loops are fundamental structures in programming that allow us to execute a block of code multiple times. Instead of writing repetitive code, loops help automate tasks, making programs more efficient and manageable. The two most commonly used loops are for and while loops.</p>
                        
  
                        <p class="card-text">Why Use Loops?</p>
                        <p class="card-text">• Reduce repetitive code.</p>
                        <p class="card-text">• Automate tasks efficiently.</p>
                        <p class="card-text">• Improve code readability and maintainability.</p>

    <!-- Video: For Loops -->
    <div class="text-align-left mt-3 mb-3">
                        <p class="card-text">1. For Loops</p>
                        <p class="card-text">The for loop is used for iterating over a sequence (such as a list, tuple, dictionary, or range).</p>
...
```
                        ...
                        <h5 class="card-title">Java Example</h5>
...
<iframe width="1090" height="400" src="https://www.youtube.com/embed/94UHCEmprCY" frameborder="0" allowfullscreen></iframe>
    </div> 

    <!-- Video: While Loops -->
    <div class="text-align-left mt-3 mb-3">
                        <p class="card-text">2. While Loops</p>
                        <p class="card-text">A while loop is used when the number of iterations is unknown, and the loop continues running as long as a specified condition is True.</p>
...
<iframe width="1090" height="400" src="https://www.youtube.com/embed/ECduJk00mUU" frameborder="0" allowfullscreen></iframe>
    </div>      
...
<div class="d-flex justify-content-center mt-4">
    ...
    <a href="viewlesson4.1.php" class="btn btn-primary btn-lg">Next</a>
</div>
                </div>
            </div>
        </div>
