...
<div class="sidebar" id="sidebar">
    ...
    <div class="container mt-5 pt-4 content">
        <h2 class="text-center mb-4">Lesson 2: Variables and Data Types</h2>
        <h3 class="text-center mb-4">Objective: Learn about different data types and how to use variables in Java.</h3>
        <div class="row">
            <div class="col-12">
                <div class="card shadow-sm">
                    <div class="card-body">
                        <h2 class="card-title">Primitive Data Types:</h2>
                        <p class="card-text">int, double, char, boolean, long, float, byte, short</p>

                        <!-- Video: Declaring Variables: -->
                        <div class="text-align-left mt-3 mb-3">
                        <h2 class="card-title">Declaring Variables:</h2>
                        <p class="card-text">Syntax: dataType variableName = value;</p>
                        
                        <p class="card-text">int age = 25;</p>
                        <p class="card-text">double salary = 50000.50;</p>
                        <p class="card-text">char grade = 'A';</p>
                        <p class="card-text">boolean isActive = true;</p>
                        <iframe width="1090" height="400" src="https://www.youtube.com/embed/tfXKvVHn5Mg" frameborder="0" allowfullscreen></iframe>
                        </div>

                        <!-- Video: String and Other Object Types: -->
                        <div class="text-align-left mt-3 mb-3">
                        <h2 class="card-title">String and Other Object Types:</h2>
                        <p class="card-text">String name = ''John'';</p>
                        <iframe width="1090" height="400" src="https://www.youtube.com/embed/P9hEmbfdiuc" frameborder="0" allowfullscreen></iframe>
                        </div>
...
<div class="d-flex justify-content-center mt-4">
    ...
    <a href="javaviewlesson2.1.php" class="btn btn-primary btn-lg">Next</a>
                </div>
            </div>
        </div>
    </div>
