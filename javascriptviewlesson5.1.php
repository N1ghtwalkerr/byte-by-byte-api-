        ...
        <div class="row">
            <div class="col-12">
                <div class="card shadow-sm">
                        <h6 class="card-title">JavaScript Classes and Objects</h6>
                        <p class="card-text">Classes are blueprints for creating objects in JavaScript. Objects are instances of classes that hold specific data.</p>
                        
                        <!-- Video: Defining a Class in JavaScript -->
                        <div class="text-align-left mt-3 mb-3">
                        <h6 class="card-title">Defining a Class in JavaScript</h6>
...
<iframe width="1090" height="400" src="https://www.youtube.com/embed/U2vxAEiaVRY" frameborder="0" allowfullscreen></iframe>
    </div> 

                        <!-- Video: Defining a Class in JavaScript -->
                        <div class="text-align-left mt-3 mb-3">
                        <h6 class="card-title">Creating an Object from a Class</h6>
...
<iframe width="1090" height="400" src="https://www.youtube.com/embed/5AWRivBk0Gw" frameborder="0" allowfullscreen></iframe>
    </div> 

                        <!-- Video: Encapsulation in JavaScript -->
                        <div class="text-align-left mt-3 mb-3">
                        <h6 class="card-title">Encapsulation in JavaScript</h6>
                        <p class="card-text">Encapsulation means restricting direct access to object properties and using getter and setter methods instead.</p>
                        
                        <h6 class="card-title">Example of Encapsulation</h6>
...
<iframe width="1090" height="400" src="https://www.youtube.com/embed/s6vSZYVELNA" frameborder="0" allowfullscreen></iframe>
    </div> 

                        <h6 class="card-title">Hands-on Activity:</h6>
              
                        <pre class="card-text">
1. Create a `Student` class with `name` and `grade` properties.
2. Implement getter and setter methods to retrieve and modify the `grade`.
...
<div class="d-flex justify-content-center mt-4">
    ...
    <a href="javascriptquiz5.php" class="btn btn-primary btn-lg">Start Quiz</a>
</div>
                    </div>
                </div>
            </div>
