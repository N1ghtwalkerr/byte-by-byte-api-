        ...
        <div class="col-12">
            <div class="card shadow-sm">
                <div class="card-body">
                    ...
                    <p class="card-text">
                        In this course, you will learn the basics of Python programming, including syntax, variables, functions, loops, and data types. 
                        By the end of this lesson, you'll be able to write simple Python programs and solve basic problems.
                    </p>
                    <ul>
                        <li><strong>Lesson 1:</strong> 
                            <a href="viewlesson1.php" class="text-primary">Python Basics</a> - Learn the syntax and the fundamentals of Python.
                        </li>
                        <li><strong>Lesson 2:</strong> 
                            <a href="viewlesson2.php" class="text-primary">Variables & Data Types</a> - Understanding variables, strings, integers, and floats.
                        </li>
                        <li><strong>Lesson 3:</strong> 
                            <a href="viewlesson3.php" class="text-primary">Functions</a> - Learn how to create and use functions to organize code.
                        </li>
                        <li><strong>Lesson 4:</strong> 
                            <a href="viewlesson4.php" class="text-primary">Loops</a> - Master for and while loops to handle repetitive tasks.
                        </li>
                        <li><strong>Lesson 5:</strong> 
                            <a href="viewlesson5.php" class="text-primary">Conditional Statements</a> - Learn how to make decisions in code using if-else conditions.
                        </li>
                    </ul>
                </div>
            </div>
