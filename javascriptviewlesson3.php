...
<div class="sidebar" id="sidebar">
    ...
    <div class="container mt-5 pt-4 content">
        ...
        <h3 class="text-center mb-4">Lesson 3 - Functions and Control Flow</h3>
        <div class="row">
            <div class="col-12">
                <div class="card shadow-sm">
                    <!-- Video: Functions in JavaScript -->
                    <div class="text-align-left mt-3 mb-3">
                        <h6 class="card-title">Functions in JavaScript</h6>
                        <p class="card-text">A function is a reusable block of code that performs a specific task. Functions help in organizing code, making it more readable, and reducing redundancy. In JavaScript, functions can be declared using the `function` keyword or as arrow functions.</p>

                        <h6 class="card-title">Defining a Function</h6>
                        <p class="card-text">To define a function, use the `function` keyword followed by a name, parentheses `( )`, and a block of code inside `{ }`. A function can take parameters and return a value.</p>
                        <h6 class="card-title">Exampleof a function that greets a user:</h6>
                        <pre class="card-text">
    ...
    <iframe width="1090" height="400" src="https://www.youtube.com/embed/N8ap4k_1QEQ" frameborder="0" allowfullscreen></iframe>
        </div>
        
                        <!-- Video: Arrow Functions -->
                        <div class="text-align-left mt-3 mb-3">
                        <h6 class="card-title">Arrow Functions</h6>

                        <p class="card-text">Arrow functions provide a more concise way to write functions. They use `=>` instead of the `function` keyword</p>
...
<iframe width="1090" height="400" src="https://www.youtube.com/embed/fRRRkognpOs" frameborder="0" allowfullscreen></iframe>
    </div>
    
                        <!-- Video: Control Flow in JavaScript -->
                        <div class="text-align-left mt-3 mb-3">
                        <h6 class="card-title">Control Flow in JavaScript</h6>

                        <p class="card-text">Control flow determines the order in which statements are executed in a program. The main control structures include `if-else` statements, `switch` statements, and loops.</p>
                        
                            <iframe width="1090" height="400" src="https://www.youtube.com/embed/-VxB_96Q3Ps" frameborder="0" allowfullscreen></iframe>
                        </div>
                        
                        <!-- Start Quiz and Back Button -->
<div class="d-flex justify-content-center mt-4">
    <a href="javascriptview.php" class="btn btn-secondary btn-lg">Back</a>
    <a href="javascriptviewlesson3.1.php" class="btn btn-primary btn-lg">Next</a>
</div>
                    </div>
                </div>
            </div>
