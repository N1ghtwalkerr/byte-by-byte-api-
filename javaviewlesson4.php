...
<div class="sidebar" id="sidebar">
    ...
    <div class="container mt-5 pt-4 content">
        <h2 class="text-center mb-4">Lesson 4: Functions/Methods in Java</h2>
        <h3 class="text-center mb-4">Objective: Understand how to define and call methods in Java.</h3>
        <div class="row">
            <div class="col-12">
                <div class="card shadow-sm">
                    <div class="card-body">
                        ...
                        <h2 class="card-title">Defining a Method:</h2>

                        <p class="card-text">Syntax: returnType methodName(parameters) { }</p>

                        <h2 class="card-title">Example:</h2>

                        <p class="card-text">public static void greet(String name) {</p>
                        <p class="card-text">   System.out.println(''Hello,''+ name);</p>
                        <p class="card-text">}</p> 
                        
                        <p class="card-text">public static void main(String[] args) {</p>
                        <p class="card-text">   greet(''John'');</p> 
                        <p class="card-text">}</p> 
                        <iframe width="1090" height="400" src="https://www.youtube.com/embed/cCgOESMQe44" frameborder="0" allowfullscreen></iframe>
                        </div>

                        <!-- Video: Java Overview: -->
                        <div class="text-align-left mt-3 mb-3">
                        <h2 class="card-title">Method Overloading:</h2>

                        <p class="card-text">public static void add(int a, int b) {</p>
                        <p class="card-text">   System.out.println(a + b);</p>
                        <p class="card-text">}</p>
                        <p class="card-text">public static void add(double a, double b) {</p>
                        <p class="card-text">   System.out.println(a + b);</p>
                        <p class="card-text">}</p>
                        <iframe width="1090" height="400" src="https://www.youtube.com/embed/cAb0nbNzabo" frameborder="0" allowfullscreen></iframe>
                        </div>
...
<div class="d-flex justify-content-center mt-4">
    ...
    <a href="javaviewlesson4.1.php" class="btn btn-primary btn-lg">Next</a>
                </div>
            </div>
        </div>
    </div>
